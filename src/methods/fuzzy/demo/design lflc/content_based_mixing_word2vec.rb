...
This variant is dealing with the Word2Vec method (trained on iDNES with the whole body text) which results were the most reliable of the content-based methods.
